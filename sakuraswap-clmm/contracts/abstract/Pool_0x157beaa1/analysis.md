# Pool 0x157beaa1c7dcc2aad79846ec693c558609ebc0ea
...
## Pair / fee tier
- token0: WETH `0x3439153eb7af838ad19d56e1571fbd09333c2809`
- token1: YGG `0xa9053dc939d74222f7aa0b3a2be407abbfd56c6a`
- fee tier: 0.3%

## Balance / controlled TVL (at time of review)
- WETH: 134.053962 ($251,660.84) — price source: eth reference price (coingecko:ethereum via coins.llama.fi)
- YGG: 14,653,980.862058 ($274,856.04) — price source: defillama coins.llama.fi
- **Total: $526,516.88**

This is the single largest funded contract found across the entire SakuraSwap CLMM deployment.
